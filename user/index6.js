...
function bukaDashboardWarga() {
    ...
    // REAL-TIME LISTENER STATUS SAMPAH
...
// LOGIKA RENDERING GRID STABIL 1 SAMPAI 31 (MURNI TANGGAL)
function gambarGridKalender(tahun, bulan) {
    ...
    // Loop murni berurutan dari tanggal 1 sampai batas akhir bulan berjalan
    for (let hari = 1; hari <= jumlahHari; hari++) {
        let rincian = dataSampahBulanIni[hari];
        
        // Warna Default: Abu-abu (Belum ada catatan / Kosong)
...
// MANAGEMENT DETEKSI KLIK DATA POP UP JAM OPERASIONAL PETUGAS
