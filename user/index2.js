...
function bukaDashboardWarga() {
    ...
    // =========================================================================
    // FITUR MONITORING STATUS SAMPAH WARGA (REAL-TIME FIREBASE)
    // =========================================================================
    ...
    lblJadwal.innerText = "Senin & Kamis (08:00 - 10:00)";

    if(statusSampahRef) statusSampahRef.off(); // Bersihkan listener lama jika ada
