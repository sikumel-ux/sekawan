...
function closeAlert() { document.getElementById('customAlert').style.setProperty('display', 'none', 'important'); }

function tuntasConfirm(message, onYes) {
    document.getElementById('confirmMsg').innerText = message;
    onConfirmSuccess = onYes;
    document.getElementById('customConfirm').style.setProperty('display', 'flex', 'important');
}

function closeConfirm() { document.getElementById('customConfirm').style.setProperty('display', 'none', 'important'); onConfirmSuccess = null; }
...
function showLoading() { document.getElementById('loading').style.setProperty('display', 'flex', 'important'); }
function hideLoading() { document.getElementById('loading').style.setProperty('display', 'none', 'important'); }
...
function st(t) {
    ...
    document.getElementById('screen-'+t).style.setProperty('display', 'block', 'important');
